...
def full_team() -> dict[str, Any]:
    ...
    doctor = worker("site_doctor", "Site Doctor",
                    ...
                    "Mandatory profile-aware accessibility, forms/privacy, dependency/SBOM, performance/load, and SEO evidence, plus one explicit Vercel, Supabase, Cloudflare, tag, and payments task. Run each provider task only when .solo/stack.md records that provider; otherwise record an evidence-backed N/A artifact.")
